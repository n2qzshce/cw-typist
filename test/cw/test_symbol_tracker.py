...
class TestSymbolTracker(BaseTestSetup):
	...
	def test_dit(self):
		symbol = self.symbol_tracker.calculate_symbol(1200, 1)
		self.assertEqual(cw_meta.DIT, symbol)

	def test_dah(self):
		symbol = self.symbol_tracker.calculate_symbol(1200 * 7, 1)
